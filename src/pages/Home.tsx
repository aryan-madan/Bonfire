...
function JoinField({ value, onChange, onSubmit, error, isValid }: {
    ...
    return (
        <div>
            <div className={`group flex items-center gap-3 rounded-2xl bg-cocoa-800 px-4 py-3.5 ring-1 transition focus-within:bg-cocoa-700 ${error ? 'ring-berry-400/50' : 'ring-transparent focus-within:ring-ember-400/30'}`}>
